...
public class Exercicio21 {
	...
	public static void main(String[] args) {
		...
		while ((horaFinal < 0) || (horaFinal > 23)) {
			System.out.println("\nDigite o horário final da partida de Xadrez: ");
		...
		if (quantidadeHorasJogo < 0) {
			...
			System.out.println("\nA duração  final do jogo chegou a 24 horas");
		} else {
			System.out.println("\nA quantidade de horas jogadas corresponde a: " + quantidadeHorasJogo + " horas");
		}
		sc.close();
	}
